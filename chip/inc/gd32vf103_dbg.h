#ifndef __GD32VF103_DBG_H
#define __GD32VF103_DBG_H
...
//hold TIMER1 counter when core is halted
#define DBG_CTL_TIMER1_HOLD		BIT(11)
//hold TIMER2 counter when core is halted
#define DBG_CTL_TIMER2_HOLD		BIT(12)
//hold TIMER3 counter when core is halted
#define DBG_CTL_TIMER3_HOLD		BIT(13)
//debug CAN0 kept when core is halted
#define DBG_CTL_CAN0_HOLD		BIT(14)
//hold I2C0 smbus when core is halted
#define DBG_CTL_I2C0_HOLD		BIT(15)
//hold I2C1 smbus when core is halted
#define DBG_CTL_I2C1_HOLD		BIT(16)
//hold TIMER4 counter when core is halted
#define DBG_CTL_TIMER4_HOLD		BIT(18)
//hold TIMER5 counter when core is halted
#define DBG_CTL_TIMER5_HOLD		BIT(19)
//hold TIMER6 counter when core is halted
#define DBG_CTL_TIMER6_HOLD		BIT(20)
//debug CAN1 kept when core is halted
