...
void timer_primary_output_config(uint32_t timer_periph, enum control_status newvalue);
/* enable or disable channel capture/compare control shadow register */
void timer_channel_control_shadow_config(uint32_t timer_periph, enum control_status newvalue);
...
enum flag_status timer_interrupt_flag_get(uint32_t timer_periph, uint32_t interrupt);
