...
#define ADC_SAMPT0(adcx) \
	REG32((adcx) + 0x0CU) /* ADC sampling time register 0 */

#define ADC_SAMPT1(adcx) \
	REG32((adcx) + 0x10U) /* ADC sampling time register 1 */

#define ADC_IOFF0(adcx)	\
	REG32((adcx) + 0x14U) /* ADC inserted channel data offset register 0 */

#define ADC_IOFF1(adcx)	\
	REG32((adcx) + 0x18U) /* ADC inserted channel data offset register 1 */

#define ADC_IOFF2(adcx)	\
	REG32((adcx) + 0x1CU) /* ADC inserted channel data offset register 2 */

#define ADC_IOFF3(adcx)	\
	REG32((adcx) + 0x20U) /* ADC inserted channel data offset register 3 */

#define ADC_WDHT(adcx) \
	REG32((adcx) + 0x24U) /* ADC watchdog high threshold register */

#define ADC_WDLT(adcx) \
	REG32((adcx) + 0x28U) /* ADC watchdog low threshold register */

#define ADC_RSQ0(adcx) \
	REG32((adcx) + 0x2CU) /* ADC regular sequence register 0 */

#define ADC_RSQ1(adcx) \
	REG32((adcx) + 0x30U) /* ADC regular sequence register 1 */

#define ADC_RSQ2(adcx) \
	REG32((adcx) + 0x34U) /* ADC regular sequence register 2 */

#define ADC_ISQ(adcx) \
	REG32((adcx) + 0x38U) /* ADC inserted sequence register */

#define ADC_IDATA0(adcx) \
	REG32((adcx) + 0x3CU) /* ADC inserted data register 0 */

#define ADC_IDATA1(adcx) \
	REG32((adcx) + 0x40U) /* ADC inserted data register 1 */

#define ADC_IDATA2(adcx) \
	REG32((adcx) + 0x44U) /* ADC inserted data register 2 */

#define ADC_IDATA3(adcx) \
	REG32((adcx) + 0x48U) /* ADC inserted data register 3 */

#define ADC_RDATA(adcx)	\
	REG32((adcx) + 0x4CU) /* ADC regular data register */

#define ADC_OVSCR(adcx)	\
	REG32((adcx) + 0x80U) /* ADC oversample control register */
...
#define ADC_MODE_FREE \
	CTL0_SYNCM(0) /* all the ADCs work independently */
...
#define ADC0_1_EXTTRIG_REGULAR_T0_CH0 \
	CTL1_ETSRC(0) /* TIMER0 CH0 event select */

#define ADC0_1_EXTTRIG_REGULAR_T0_CH1 \
	CTL1_ETSRC(1) /* TIMER0 CH1 event select */

#define ADC0_1_EXTTRIG_REGULAR_T0_CH2 \
	CTL1_ETSRC(2) /* TIMER0 CH2 event select */

#define ADC0_1_EXTTRIG_REGULAR_T1_CH1 \
	CTL1_ETSRC(3) /* TIMER1 CH1 event select */

#define ADC0_1_EXTTRIG_REGULAR_T2_TRGO \
	CTL1_ETSRC(4) /* TIMER2 TRGO event select */

#define ADC0_1_EXTTRIG_REGULAR_T3_CH3 \
	CTL1_ETSRC(5) /* TIMER3 CH3 event select */

#define ADC0_1_EXTTRIG_REGULAR_EXTI_11 \
	CTL1_ETSRC(6) /* external interrupt line 11 */

#define ADC0_1_EXTTRIG_REGULAR_NONE \
	CTL1_ETSRC(7) /* software trigger */
...
#define ADC0_1_EXTTRIG_INSERTED_T0_TRGO \
	CTL1_ETSIC(0) /* TIMER0 TRGO event select */

#define ADC0_1_EXTTRIG_INSERTED_T0_CH3 \
	CTL1_ETSIC(1) /* TIMER0 CH3 event select */

#define ADC0_1_EXTTRIG_INSERTED_T1_TRGO \
	CTL1_ETSIC(2) /* TIMER1 TRGO event select */

#define ADC0_1_EXTTRIG_INSERTED_T1_CH0 \
	CTL1_ETSIC(3) /* TIMER1 CH0 event select */
#define ADC0_1_EXTTRIG_INSERTED_T2_CH3 \
	CTL1_ETSIC(4) /* TIMER2 CH3 event select */

#define ADC0_1_EXTTRIG_INSERTED_T3_TRGO \
	CTL1_ETSIC(5) /* TIMER3 TRGO event select */

#define ADC0_1_EXTTRIG_INSERTED_EXTI_15 \
	CTL1_ETSIC(6) /* external interrupt line 15 */

#define ADC0_1_EXTTRIG_INSERTED_NONE \
	CTL1_ETSIC(7) /* software trigger */
...
#define OVSCR_OVSS(regval) \
	(BITS(5,8) & ((uint32_t) (regval) << 5))
...
#define OVSCR_OVSR(regval) \
	(BITS(2,4) & ((uint32_t) (regval) << 2))
...
enum flag_status adc_interrupt_flag_get(uint32_t adc_periph, uint32_t adc_interrupt);
