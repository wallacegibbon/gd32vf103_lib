...
// external crystal oscillator clock bypass mode enable
...
// SRAM clock enable when sleep mode
...
#define RCU_REG_VAL(periph) \
	(REG32(RCU + ((uint32_t) (periph) >> 6)))

#define RCU_BIT_POS(val) \
	((uint32_t) (val) & 0x1FU)


// AHB enable register offset
#define AHBEN_REG_OFFSET		0x14U
// APB1 enable register offset
#define APB1EN_REG_OFFSET		0x1CU
// APB2 enable register offset
#define APB2EN_REG_OFFSET		0x18U

// AHB reset register offset
#define AHBRST_REG_OFFSET		0x28U
// APB1 reset register offset
#define APB1RST_REG_OFFSET		0x10U
// APB2 reset register offset
#define APB2RST_REG_OFFSET		0x0CU

// reset source/clock register offset
#define RSTSCK_REG_OFFSET		0x24U

// control register offset
#define CTL_REG_OFFSET			0x00U
// backup domain control register offset
#define BDCTL_REG_OFFSET		0x20U


// clock stabilization and stuck interrupt
// clock interrupt register offset
...
enum rcu_periph_reset {
	...
	// alternate function clock reset
...
enum rcu_int {
	...
	// PLL1 stabilization interrupt
	RCU_INT_PLL1STB = RCU_REGIDX_BIT(INT_REG_OFFSET, 13U),

	// PLL2 stabilization interrupt
...
// system clock source select HXTAL
...
// system clock source select PLLP
...
// APB2 prescaler select CK_AHB/2
#define RCU_APB2_CKAHB_DIV2		CFG0_APB2PSC(4)

// APB2 prescaler select CK_AHB/4
#define RCU_APB2_CKAHB_DIV4		CFG0_APB2PSC(5)

// APB2 prescaler select CK_AHB/8
#define RCU_APB2_CKAHB_DIV8		CFG0_APB2PSC(6)

// APB2 prescaler select CK_AHB/16
#define RCU_APB2_CKAHB_DIV16		CFG0_APB2PSC(7)


// ADC prescaler select CK_APB2/2 (or CK_APB2/4, CK_APB2/6, ....)
...
// HXTAL clock selected as source clock of PLL
...
// USBFS prescaler select CK_PLL/1 (or CK_PLL/2.5, CK_PLL/2)
...
// RTC source clock select LXTAL 
#define RCU_RTCSRC_LXTAL		BDCTL_RTCSRC(1)

// RTC source clock select IRC40K
#define RCU_RTCSRC_IRC40K		BDCTL_RTCSRC(2)

// RTC source clock select HXTAL/128
...
// I2S1 clock source selection
// system clock selected as I2S1 source clock
#define RCU_I2S1SRC_CKSYS		((uint32_t) 0x00000000U)

// (CK_PLL2 x 2) selected as I2S1 source clock
#define RCU_I2S1SRC_CKPLL2_MUL2		RCU_CFG1_I2S1SEL

// I2S2 clock source selection
// system clock selected as I2S2 source clock
#define RCU_I2S2SRC_CKSYS		((uint32_t) 0x00000000U)

// (CK_PLL2 x 2) selected as I2S2 source clock
...
// HXTALEN or LXTALEN must be reset before it
