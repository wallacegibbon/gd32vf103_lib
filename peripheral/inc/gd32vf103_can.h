...
typedef struct {
	...
	enum control_status time_triggered;	/* time triggered communication mode */
	enum control_status auto_bus_off_recovery;	/* automatic bus-off recovery */
	enum control_status auto_wake_up;	/* automatic wake-up mode */
	enum control_status no_auto_retrans;	/* automatic retransmission mode disable */
