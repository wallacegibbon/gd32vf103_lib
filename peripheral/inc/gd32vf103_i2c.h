...
enum flag_status i2c_interrupt_flag_get(uint32_t i2c_periph,enum i2c_interrupt_flag int_flag);
/* clear I2C interrupt flag */
void i2c_interrupt_flag_clear(uint32_t i2c_periph,enum i2c_interrupt_flag int_flag);
