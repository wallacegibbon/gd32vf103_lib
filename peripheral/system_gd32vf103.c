	...
	case SEL_PLL:
		...
		if (RCU_PLLSRC_IRC8M_DIV2 == pllsel) {
			...
			if (RCU_PREDV0SRC_CKPLL1 == predv0sel) {
				predv1 =
				    ((RCU_CFG1 & RCU_CFG1_PREDV1) >> 4) + 1U;
				pll1mf =
				    ((RCU_CFG1 & RCU_CFG1_PLL1MF) >> 8) + 2U;
...
// configure the system clock to HXTAL
static void system_clock_hxtal(void) {
	uint32_t timeout = 0U;
...
// configure the system clock to 24M by PLL which selects
// HXTAL(MD/HD/XD:8M; CL:25M) as its clock source
static void system_clock_24m_hxtal(void) {
	uint32_t timeout = 0U;
	uint32_t stab_flag = 0U;
...
#elif defined (__SYSTEM_CLOCK_48M_PLL_HXTAL)
// configure the system clock to 48M by PLL which selects
// HXTAL(MD/HD/XD:8M; CL:25M) as its clock source
static void system_clock_48m_hxtal(void) {
	uint32_t timeout = 0U;
	uint32_t stab_flag = 0U;
...
// configure the system clock to 56M by PLL which selects
// HXTAL(MD/HD/XD:8M; CL:25M) as its clock source
static void system_clock_56m_hxtal(void) {
	uint32_t timeout = 0U;
	uint32_t stab_flag = 0U;
...
// configure the system clock to 72M by PLL which selects
// HXTAL(MD/HD/XD:8M; CL:25M) as its clock source
static void system_clock_72m_hxtal(void) {
	uint32_t timeout = 0U;
	uint32_t stab_flag = 0U;
...
// configure the system clock to 96M by PLL which selects
// HXTAL(MD/HD/XD:8M; CL:25M) as its clock source
static void system_clock_96m_hxtal(void) {
	uint32_t timeout = 0U;
	uint32_t stab_flag = 0U;
...
// configure the system clock to 108M by PLL which selects
// HXTAL(MD/HD/XD:8M; CL:25M) as its clock source
static void system_clock_108m_hxtal(void) {
	uint32_t timeout = 0U;
	uint32_t stab_flag = 0U;
...
// configure the system clock to 48M by PLL which selects IRC8M as its clock
// source
static void system_clock_48m_irc8m(void) {
	uint32_t timeout = 0U;
	uint32_t stab_flag = 0U;
