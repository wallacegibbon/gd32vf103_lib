...
void SystemInit(void) {
	...
	RCU_CTL &=
	    ~(RCU_CTL_PLLEN | RCU_CTL_PLL1EN | RCU_CTL_PLL2EN | RCU_CTL_CKMEN |
	      RCU_CTL_HXTALEN);
...
static void system_clock_24m_hxtal(void) {
	...
	if (HXTAL_VALUE == 25000000) {
		...
		RCU_CFG1 &=
		    ~(RCU_CFG1_PREDV0SEL | RCU_CFG1_PLL1MF | RCU_CFG1_PREDV1 |
		      RCU_CFG1_PREDV0);
		RCU_CFG1 |=
		    (RCU_PREDV0SRC_CKPLL1 | RCU_PLL1_MUL8 | RCU_PREDV1_DIV5 |
		     RCU_PREDV0_DIV10);
		...
		RCU_CFG1 &=
		    ~(RCU_CFG1_PREDV0SEL | RCU_CFG1_PREDV1 | RCU_CFG1_PLL1MF |
		      RCU_CFG1_PREDV0);
	...
	if (HXTAL_VALUE == 25000000) {
		...
		RCU_CFG1 &=
		    ~(RCU_CFG1_PREDV0SEL | RCU_CFG1_PREDV1 | RCU_CFG1_PLL1MF |
		      RCU_CFG1_PREDV0);
		RCU_CFG1 |=
		    (RCU_PREDV0SRC_CKPLL1 | RCU_PREDV1_DIV5 | RCU_PLL1_MUL8 |
		     RCU_PREDV0_DIV10);
		...
		RCU_CFG1 &=
		    ~(RCU_CFG1_PREDV0SEL | RCU_CFG1_PREDV1 | RCU_CFG1_PLL1MF |
		      RCU_CFG1_PREDV0);
		RCU_CFG1 |=
		    (RCU_PREDV0SRC_HXTAL | RCU_PREDV0_DIV2 | RCU_PREDV1_DIV2 |
